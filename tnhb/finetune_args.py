...
model_g.add_arg("init_checkpoint",          str,  'data/models/step_15000',           "Init checkpoint to resume training from.")
model_g.add_arg("init_pretraining_params",  str,  'model/params',
                "Init pre-training params which preforms fine-tuning from. If the "
                 "arg 'init_checkpoint' has been set, this argument wouldn't be valid.")

model_g.add_arg("checkpoints",              str,  'data/models/',  "Path to save checkpoints.")
...
train_g.add_arg("epoch",             int,    0,       "Number of epoches for fine-tuning.")
...
train_g.add_arg("save_steps",        int,    10000,   "The steps interval to save models.")
train_g.add_arg("validation_steps",  int,    1,    "The steps interval to evaluate model performance.")
...
data_g.add_arg("test_set",            str,  'data/test1.json',  "Path to test data.")
...
data_g.add_arg("in_tokens",           bool, False,
              ...
              "Otherwnum_iteration_per_drop_scopeise, it will be the maximum number of examples in one batch.")
