...
提供一段搜索词，去百度知道搜索答案。回复第一个题目及回答内容。
回答的内容为多个答案相加。取前500字。每个答案之间用"+++"链接。
'''

import business.getPage as getPage 
...
def Query(word):
    ...
    #问题页面代码
    QuestionPageHtmlCode=QuestionPage['HtmlCode']
