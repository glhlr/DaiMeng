...
Exp_dic = {'V':'@S0呀@S0,有意思+@S0那是必须的+一起聊聊@S0+这是谈@S0的时候吗？+@S0...恩...@S0还不错+为什么要讲@S0呢+不知@S0谁最强+@S0挺好的+@S0的事儿好开心+我也知道S0+S0S0忘不了+S0的事情很一般',
            '逻辑':'有个@S0,好嘛+这下子,@S0了',
           ...
           '主语+V+宾语':'有人说@S1@S2的事+@S0经常@S1@S2吗，真好+我也想@S1一下@S2！+ @S1@S2我也要去！+@S0呀@S0，@S1@S2吧+@S1@S2的是@S1呢',
            '计量':'我数数，真是@S0+还有@S0+@S0好多啊+@S0给我一个行不',
           '同类词':'',
...
Rem_dic = {'日常.动词':'每天都会@S1一下+谁离得开@S1呢+@S1@S更健康',
           '日常.名词':'@S1无处不在+@S1会随时出现',
           '日常':'每天想想@S1+@S1的事儿记心上+说着说着就能碰上@S1',
'经常':'@S1不是难事+常常@S1点啥+@S1小意思了',
...
T_dic = {'T.时间.运行':'时间如流水+时光飞逝+光阴似箭，日月如梭+时光一去不复返',
         'T.时间.态度':'寸金难买寸光阴+珍惜时间+惜时如金+要节约时间+浪费时间就是犯罪+一寸光阴一寸金',
         'T.继续':'的事持续中+继续在讲+嗨个没完+还在念叨呢+在前后呼应',
         'T.时空_自然': '阳光雨露，滋润万物生灵+春夏秋冬，时光与万物轮回+花鸟鱼虫，万类霜天+天空之下，生命不息+天空大地，是生命的舞台',
         'T.离别_回家': '真是相见时难别亦难啊+此去几时回？回时莫徘徊+老话说天下没有不散的宴席+这一走要去多远啊+古时候离别后再见好难啊+真是人有悲欢离合啊',
         'T.送别宴': '送别时要喝酒唱歌，一醉方休+送君千米，终有一别+现在来回很方便，回来要给我带礼物+以后我们出去春节再忙也要回来哦+经常联系，天天要陪我聊天',
         'T.感动':'因为有爱所以感动？+小孩子不知发愁+要经过很多很多事，才会多愁善感+这个事情太感人了！',
         'T.音乐': '有音乐，不悲伤+听了这曲，我想唱唱跳跳+好的音乐净化心灵+这是神曲吗？+好音乐，在路上',
...
Cs_dic = {'送别宴':'主人|客人.客,朋友.友,亲人.兄弟|招待,宴|酒,醉,音乐|离别,出发.发',
          '音乐':'乐器|演奏.弹奏.弹|声.音|仙乐,好听',
          '感动':'音乐.歌.曲,文章,电影|动情|欢乐,流泪.哭泣.泣',
          '离别_回家':'去.别.走.离.离开|时间,久,空间,遥远|思念.相思,几时.何日|回.归.返.来.还,相聚',
          '虚度_悲哀':'年少|寻欢,消闲,不~努力,懒|~时间,等闲度|年老,老大,白发|坏情,悲哀,伤感',
	  '时空_自然':'时间,季节.春.夏.秋.冬.天|陆地,空域,水域.江.海.潮水|植物.花.树|鸟,兽,鱼,虫'
}
